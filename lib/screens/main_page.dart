...
import 'package:abderazak_manfaloti/components/content_card.dart';
import 'package:abderazak_manfaloti/apis/calls.dart';
import 'package:abderazak_manfaloti/components/header.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: Text('عبد الرزاق المونفالوطي'),
        ),
        body: FutureBuilder(
                  ...
                  return Container(
                    child: SafeArea(
                      ...
                      child: Column(
                        children: [
                          Header(
                            background: "assets/manfalouti_header.jpg",
                            avatar: "assets/icone_monfalouti.png",
                          ),
                          /*Text(
                  widget.label,
